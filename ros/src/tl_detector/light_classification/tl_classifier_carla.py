...
class TLClassifier(object):
    ...
    def classify_using_hsv_carla(self, image):
        lower_filter=np.array([20,35,250])
        upper_filter=np.array([65,130,255])
        threshold=18000
        state = TrafficLight.UNKNOWN
        
        small_img=cv2.resize(image,(800,600), 0, 0, cv2.INTER_LINEAR)
